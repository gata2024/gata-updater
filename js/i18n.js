...
const I18N = {
  ...
  strings: {
    ...
    en: {
      ...
      "gate.ser.text": "Press the button and SELECT the controller in the list — usually “STM32 Virtual ComPort”, “USB Serial Device” or “STM32 Bootloader” (COMxx) — then press Connect. IF THE LIST IS EMPTY: leave this window open and switch the controller OFF and ON — it appears in the list within a couple of seconds, because the controller only offers its update port for 15 seconds after each start.",
    ...
    ar: {
      ...
      "gate.ser.text": "اضغط الزر واختر وحدة التحكم من القائمة — تظهر عادةً باسم “STM32 Virtual ComPort” أو “USB Serial Device” أو “STM32 Bootloader” (COMxx) — ثم اضغط Connect. إذا كانت القائمة فارغة: اترك هذه النافذة مفتوحة وأطفئ اللوحة ثم شغّلها — ستظهر خلال ثانيتين، لأن اللوحة تتيح منفذ التحديث لمدة 15 ثانية فقط بعد كل تشغيل.",
    ...
    tr: {
      ...
      "gate.ser.text": "Düğmeye basın ve listeden kontrol ünitesini SEÇİN — genellikle “STM32 Virtual ComPort”, “USB Serial Device” veya “STM32 Bootloader” (COMxx) olarak görünür — sonra Connect'e basın. LİSTE BOŞSA: bu pencereyi açık bırakın ve kartı KAPATIP AÇIN — birkaç saniye içinde listede belirir; kart güncelleme portunu her açılıştan sonra yalnızca 15 saniye sunar.",

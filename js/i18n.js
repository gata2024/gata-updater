...
const I18N = {
  ...
  strings: {
    ...
    en: {
      ...
      "gate.connect.text": "Board in BOOT mode (hold BOOT, press+release RESET, release BOOT): press the blue button and pick “STM32 BOOTLOADER” from the list. Board running normally instead: press the second button and pick “STM32 Virtual ComPort”. Tip: start the updater with CLICK_ME_START_ON_PC.bat and approve its one-time admin popup — after that the connection is fully automatic and this question never appears.",
    ...
    ar: {
      ...
      "gate.connect.text": "اللوحة في وضع BOOT (اضغط باستمرار BOOT، اضغط وحرّر RESET، ثم حرّر BOOT): اضغط الزر الأزرق واختر “STM32 BOOTLOADER” من القائمة. أما إذا كانت اللوحة تعمل بشكل طبيعي: اضغط الزر الثاني واختر “STM32 Virtual ComPort”. نصيحة: شغّل المحدّث عبر CLICK_ME_START_ON_PC.bat ووافق على نافذة المسؤول التي تظهر مرة واحدة — بعدها يصبح الاتصال تلقائيًا بالكامل ولن يظهر هذا السؤال مجددًا.",
    ...
    tr: {
      ...
      "gate.connect.text": "Kart BOOT modundaysa (BOOT'u basılı tutun, RESET'e basıp bırakın, BOOT'u bırakın): mavi düğmeye basın ve listeden “STM32 BOOTLOADER”ı seçin. Kart normal çalışıyorsa: ikinci düğmeye basın ve “STM32 Virtual ComPort”u seçin. İpucu: güncelleyiciyi CLICK_ME_START_ON_PC.bat ile başlatın ve bir kez görünen yönetici penceresini onaylayın — sonrasında bağlantı tamamen otomatik olur ve bu soru bir daha görünmez.",

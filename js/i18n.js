...
const I18N = {
  ...
  strings: {
    ...
    en: {
      ...
      "btn.useBuiltin": "Use the firmware included with this app",
      "btn.pickFiles": "Choose firmware files…",
      "badge.picked": "chosen files",
      "local.hintBuiltin": "Firmware included with this app — it is stored on this device, so it works without internet:",
      "local.hintPicked": "Firmware files you chose from this device:",
      "local.hintPick": "Choose the .bin files you were sent (controller_… and system_…, plus the four cloud-module files if the board has one).",
      "local.pickNothing": "Those files were not recognised. Pick the .bin files you were sent: controller_….bin, system_….bin and, for a board with a cloud module, bootloader.bin, partitions.bin, boot_app0.bin and firmware.bin.",
      ...
      "local.receiptFor": "prepared for {c} on {d} — these files are checked automatically before anything is installed",
      "local.builtAt": "built {d}",
      "local.espNotIncluded": "not included — this board has no cloud module",
      ...
      "d.windowOpen": "The controller is now waiting in update mode for up to 10 minutes — take your time picking it from the list.",
      ...
      "d.espNotIncluded": "Cloud module: this software has none — not needed on this board.",
    ...
    ar: {
      ...
      "btn.useBuiltin": "استخدام البرنامج المضمّن في هذا التطبيق",
      "btn.pickFiles": "اختيار ملفات البرنامج…",
      "badge.picked": "ملفات مختارة",
      "local.hintBuiltin": "البرنامج المضمّن في هذا التطبيق — محفوظ على هذا الجهاز ويعمل بدون إنترنت:",
      "local.hintPicked": "ملفات البرنامج التي اخترتها من هذا الجهاز:",
      "local.hintPick": "اختر ملفات ‎.bin‎ التي استلمتها (‎controller_…‎ و‎system_…‎، بالإضافة إلى ملفات وحدة السحابة الأربعة إن وُجدت في اللوحة).",
      "local.pickNothing": "لم يتم التعرف على هذه الملفات. اختر ملفات ‎.bin‎ التي استلمتها: ‎controller_….bin‎ و‎system_….bin‎، وللوحة فيها وحدة سحابة: bootloader.bin و partitions.bin و boot_app0.bin و firmware.bin.",
      ...
      "local.receiptFor": "أُعدّ لـ {c} بتاريخ {d} — يتم فحص هذه الملفات تلقائيًا قبل أي تثبيت",
      "local.builtAt": "تم بناؤه {d}",
      "local.espNotIncluded": "غير مضمّنة — لا توجد وحدة سحابة في هذه اللوحة",
      ...
      "d.windowOpen": "وحدة التحكم الآن في وضع التحديث وتنتظر حتى 10 دقائق — خذ وقتك في اختيارها من القائمة.",
      ...
      "d.espNotIncluded": "وحدة السحابة: هذا البرنامج لا يتضمنها — غير مطلوبة على هذه اللوحة.",
    ...
    tr: {
      ...
      "btn.useBuiltin": "Bu uygulamayla gelen yazılımı kullan",
      "btn.pickFiles": "Yazılım dosyalarını seç…",
      "badge.picked": "seçilen dosyalar",
      "local.hintBuiltin": "Bu uygulamayla gelen yazılım — bu cihazda saklanır, internetsiz de çalışır:",
      "local.hintPicked": "Bu cihazdan seçtiğiniz yazılım dosyaları:",
      "local.hintPick": "Size gönderilen .bin dosyalarını seçin (controller_… ve system_…, kartta bulut modülü varsa dört bulut modülü dosyası da).",
      "local.pickNothing": "Bu dosyalar tanınmadı. Size gönderilen .bin dosyalarını seçin: controller_….bin, system_….bin ve bulut modüllü kart için bootloader.bin, partitions.bin, boot_app0.bin, firmware.bin.",
      ...
      "local.receiptFor": "{c} için {d} tarihinde hazırlandı — bu dosyalar kurulumdan önce otomatik olarak denetlenir",
      "local.builtAt": "derlendi {d}",
      "local.espNotIncluded": "dahil değil — bu kartta bulut modülü yok",
      ...
      "d.windowOpen": "Kontrol ünitesi şimdi 10 dakikaya kadar güncelleme modunda bekliyor — listeden seçmek için acele etmeyin.",
      ...
      "d.espNotIncluded": "Bulut modülü: bu yazılımda yok — bu kartta gerekli değil.",

...
const I18N = {
  ...
  strings: {
    ...
    en: {
      ...
      "d.espRev6": "Cloud module: not yet updatable on rev 6 boards — skipped.",
      "err.espRev6": "The cloud module (ESP32) cannot be updated on rev 6 boards yet.",
      "hint.espRev6": "The installed system firmware reaches the ESP32 over the rev 5 wiring only. A rev 6 capable system firmware is coming; the controller software itself updates normally.",
    ...
    ar: {
      ...
      "d.espRev6": "وحدة السحابة: لا يمكن تحديثها بعد على لوحات الإصدار 6 — تم التخطي.",
      "err.espRev6": "لا يمكن بعد تحديث وحدة السحابة (ESP32) على لوحات الإصدار 6.",
      "hint.espRev6": "برنامج النظام المثبّت يصل إلى ESP32 عبر توصيلات الإصدار 5 فقط. برنامج نظام يدعم الإصدار 6 قادم؛ برنامج وحدة التحكم نفسه يتحدّث بشكل طبيعي.",
    ...
    tr: {
      ...
      "d.espRev6": "Bulut modülü: rev 6 kartlarda henüz güncellenemiyor — atlandı.",
      "err.espRev6": "Bulut modülü (ESP32) rev 6 kartlarda henüz güncellenemiyor.",
      "hint.espRev6": "Yüklü sistem yazılımı ESP32'ye yalnızca rev 5 bağlantısıyla ulaşır. Rev 6 destekli sistem yazılımı yolda; kontrol ünitesi yazılımı normal şekilde güncellenir.",

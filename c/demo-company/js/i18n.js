...
const I18N = {
  ...
  strings: {
    ...
    en: {
      ...
      "d.replug": "Waiting — unplug and re-plug the USB cable",
      "gate.replug.text": "The controller restarted into update mode and is waiting. Some phones stop the USB port when the attached device restarts: UNPLUG AND RE-PLUG THE USB CABLE, then press the button and pick “GATA Controller”. The controller waits for several minutes, so there is no rush.",
    ...
    ar: {
      ...
      "d.replug": "بانتظار اللوحة — افصل كابل USB وأعد توصيله",
      "gate.replug.text": "أعادت اللوحة التشغيل ودخلت وضع التحديث وهي تنتظر الآن. بعض الهواتف توقف منفذ USB عند إعادة تشغيل الجهاز الموصول: افصل كابل USB وأعد توصيله، ثم اضغط الزر واختر “GATA Controller”. اللوحة تنتظر عدة دقائق، فلا داعي للعجلة.",
    ...
    tr: {
      ...
      "d.replug": "Bekleniyor — USB kablosunu çıkarıp takın",
      "gate.replug.text": "Kontrol ünitesi yeniden başlayıp güncelleme moduna geçti ve bekliyor. Bazı telefonlar bağlı cihaz yeniden başlayınca USB portunu durdurur: USB KABLOSUNU ÇIKARIP TAKIN, sonra düğmeye basıp “GATA Controller” cihazını seçin. Kart birkaç dakika bekler, acele etmeye gerek yok.",
